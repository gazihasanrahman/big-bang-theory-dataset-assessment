...
class ImdbSourcedEpisode(Base):
    ...
    directorss = relationship("Directors", back_populates="imdbsourcedepisode", uselist = False)
    writerss = relationship("Writers", back_populates="imdbsourcedepisode")
    teleplaycoordinatorss = relationship("TeleplayCoordinators", back_populates="imdbsourcedepisode")
...
class Directors(Base):
    ...
    season_id = Column(String(8), ForeignKey('imdb_sourced_episode.season_id'), nullable=False)
    directed_by = Column(String(200), nullable=False)
    imdbsourcedepisodes = relationship("ImdbSourcedEpisode", back_populates="directorss")
...
class Writers(Base):
    ...
    imdbsourcedepisodes = relationship("ImdbSourcedEpisode", back_populates="writerss")
...
class TeleplayCoordinators(Base):
    ...
    imdbsourcedepisodes = relationship("ImdbSourcedEpisode", back_populates="teleplaycoordinatorss")
